          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">Website Design</h1>
                <p className="text-lg text-muted-foreground mb-4">
                  We create websites that look great, are easy to navigate, and work smoothly on any device. Our team customizes each design to match your brand and appeal to your target audience.
                </p>
                <p className="text-lg text-muted-foreground mb-8">
                  We focus on fast loading, mobile compatibility, and SEO to help your site attract more visitors and build trust.
                </p>
                <Link to="/portfolio">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <h2 className="text-2xl md:text-3xl font-bold text-background max-w-md">
                Let's build a website that's uniquely yours!
              </h2>
              <Link to="/contact">
