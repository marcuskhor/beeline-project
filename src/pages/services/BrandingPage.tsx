          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">Branding</h1>
                <p className="text-lg text-muted-foreground mb-4">
                  A branding strategy helps create a clear identity, making it easier for customers to recognize and connect with your brand. It ensures consistency across all channels, builds trust, and differentiates you from competitors.
                </p>
                <p className="text-lg text-muted-foreground mb-8">
                  A strong strategy also fosters customer loyalty and increases your brand's value, driving growth and sales.
                </p>
                <Link to="/portfolio">
